...
namespace DrsfanBook.DataAcess.Migrations
{
    ...
    [Migration("20241022165725_addOrderDetailAndOrderHeaderTable")]
    partial class addOrderDetailAndOrderHeaderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DrsfanBook.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrsfanBook.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrsfanBook.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrsfanBook.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DrsfanBook.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("DrsfanBook.Models.OrderDetail", b =>
                {
                    b.HasOne("DrsfanBook.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DrsfanBook.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("DrsfanBook.Models.OrderHeader", b =>
                {
                    b.HasOne("DrsfanBook.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("DrsfanBook.Models.ApplicationUser", b =>
                {
                    b.HasOne("DrsfanBook.Models.Company", "Company")
                        .WithMany()
